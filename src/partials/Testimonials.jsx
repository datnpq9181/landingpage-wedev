              ...
              <div className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up" data-aos-delay="200">
                ...
                <div className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up" data-aos-delay="400">
                  <div>
                    ...
                    <blockquote className="text-lg text-gray-400 grow">— Tiện và lợi cho người sử dụng. Giao diện đơn giản, không quá màu mè nhưng thẳng vấn đề, hiệu quả cho việc quản lý dòng tiền. Mình đã áp dụng thử 01 tháng cho chuỗi 20 cửa hàng bán lẻ, đánh giá cao tính khả thi của phần mềm này.</blockquote>
                    <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                      <cite className="text-gray-200 not-italic">Mr. Austin Ngô - CEO</cite> - <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out" href="#0">CMN Vietnam</a>
                    </div>
                  </div>
